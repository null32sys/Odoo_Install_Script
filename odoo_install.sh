...
ODOO_CONFIG="/etc/$ODOO_USER/$ODOO_USER.conf"
...
sudo su root -c "echo 'ExecStart=$ODOO_HOME/$ODOO_USER/odoo-bin -c /etc/$ODOO_USER/$ODOO_USER.conf' >> /etc/systemd/system/$ODOO_USER.service"
